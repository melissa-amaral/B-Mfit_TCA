...
public class Modalidade_UsuarioDAOImpl implements Modalidade_UsuarioDAO {
    ...
    public Modalidade_Usuario atualiza(Modalidade_Usuario mu) throws SQLException {
        ...
        PreparedStatement stm = con.prepareStatement("UPDATE tca_modalidade_usuario SET data_termino=? WHERE id_usuario = ? and data_termino is null");
    ...
    public Modalidade_Usuario buscaModalidadeUsuario(Usuario u) throws SQLException{
        ...
        PreparedStatement stm = con.prepareStatement("SELECT * FROM tca_modalidade_usuario where id_usuario=? AND data_termino is null");
    ...
    public Modalidade_Usuario buscaRapidaMU(Usuario u) throws SQLException{
        Modalidade_Usuario mu = null;
